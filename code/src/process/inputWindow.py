...
class InputWindow:
    ...
    def __init__(self, root):
        ...
        if InputWindow.fname:
            self.textFilename.insert(0, InputWindow.fname)
            self.open_file(InputWindow.fname)
        else:
            self.textFilename.insert(0, "No file chosen")
        ...
        hdu = fits.open(InputWindow.fname)
